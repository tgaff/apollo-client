...
export class QueryData<TData, TVariables> extends OperationData {
  ...
  private resubscribeToQuery() {
    ...
    const lastError = this.currentObservable.getLastError();
    const lastResult = this.currentObservable.getLastResult();
    this.currentObservable.resetLastResults();
    this.startQuerySubscription();
    Object.assign(this.currentObservable, {
      lastError,
      lastResult
    });
  }
